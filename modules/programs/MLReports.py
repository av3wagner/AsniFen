...
from datetime import datetime
st_time = timestart.strftime("%d/%m/%Y, %H:%M:%S")
print("Старт программы: " + str(st_time))
st.write("Старт программы: " + str(st_time))
...
print(txt)
st.write("Общее время работы программы составляет: 00:" + str(t) + t2)
