...
with open(f"https://github.com/av3wagner/AsniFen/raw/main/WagnerFoto.jpg", "rb") as img_file:    
    img = "data:image/png;base64," + base64.b64encode(img_file.read()).decode()
	
with open(f"https://github.com/av3wagner/AsniFen/raw/main/ASFEN_LOGO3.jpg", "rb") as img_file:
...
def welcome():
    ...
    with col2:  
        ...
        st.markdown("")
        MdFileToStreamlit(f"https://github.com/av3wagner/AsniFen/raw/main/AWresume.md")
...
with st.expander("2. Собрание избранных статей из области биостатистики и Data Science"):
    ...
    with col2:  
        st.markdown("")
        MdFileToStreamlit(f"https://github.com/av3wagner/AsniFen/raw/main/ArtikelList.md")
